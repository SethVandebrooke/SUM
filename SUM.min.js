function $SUM(name,uid){var app=this;app.uid=uid||"username";if(localStorage.getItem("uid")!=null){app.uid=localStorage.getItem("uid")}
...
response[title]=val}}
return response}}(function(w){var app=new $SUM("defaultApp");if(document.querySelectorAll("html")[0].getAttribute("force-login")?true:!1){if(!app.loggedIn()){window.location.href=document.querySelectorAll("html")[0].getAttribute("force-login")}}
