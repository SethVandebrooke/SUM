...
var s=0
s=5*r(a,t),s+=3*r(e.getAttribute("id"),t),s+=3*r(o,t),s+=4*r(i,t)
var u=0
...
if(null==e&&1===r.length){var o=a.searchContext("login")+a.searchContext("signin")+a.searchContext("sign in"),i=a.searchContext("singup")+a.searchContext("sing up")+a.searchContext("register"),s=a.searchContext("update")+a.searchContext("edit")+a.searchContext("change")
